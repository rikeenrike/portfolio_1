<template>
  <section id="section2">
    <div
      class="thisbg bg-dark rounded-tl-[15px] rounded-tr-[15px] flex flex-col justify-center items-center px-[12px] xl:px-[112px]">
      ...
      <div class="text-clamp1 font-black text-dark my-[20%] leading-[1.25em]">
        <h1 id="goal">
          ...
          <span id="gradient"
            ...
            <span id="highlight" class="bg-inherit text-transparent">inspiring</span>
          </span>
          ...
          <span id="gradient"
            ...
            <span id="highlight" class="bg-inherit text-transparent">seamless development</span>
          </span>
          and
          <span id="gradient"
            class="bg-gradient-to-r from-emerald-500 via-teal-500, via-cyan-500 to-emerald-500 bg-[length:200%_auto] bg-clip-text">
            <span id="highlight" class="bg-inherit text-transparent">design</span>
          </span>
