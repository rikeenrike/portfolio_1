<template>
  <div class="fixed z-10 bg-main-bg">
    <div
      id="mainnav"
      class="h-[60px] px-[12px] xl:px-[40px] xl:h-[60px] w-screen flex items-center justify-between"
    >
      <div class="flex items-center">
        <svg
          @click="scrolltohere(-1)"
        ...
        >
          <path
            id="paperplane"
            d="M23.179 2.21749L44.1222 51.9576L23.179 42.6313L2.23584 51.9576L23.179 2.21749Z"
            stroke="#0E0E0C"
            stroke-width="3.92685"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
          <path
            id="paperplane"
            d="M23.1798 42.795V2.21754"
            stroke="#0E0E0C"
            stroke-width="3.92685"
            stroke-linecap="round"
            stroke-linejoin="round"
      ...
      <div class="flex items-center space-x-2">
        ...
        <button
          ...
          class="cursor-none px-5 py-1 rounded-2xl text-white bg-black"
        >
          Let's chat.
        </button>
      </div>
