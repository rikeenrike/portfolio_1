...
<template>
  <section
    id="section0"
    class="select-none h-screen grid items-center px-[12px] lg:grid-cols-[1fr,1fr] xl:px-[112px]"
  >
    ...
    <div class="flex flex-col lg:mt-28 h-4/5">
      ...
      <div class="flex-wrap lg:flex lg:w-[450px] xl:w-[600px] 2xl:w-auto">
        ...
        >
          <p @click="scrolltohere(0)" class="mr-[20px]" id="navmain">
            about me
          </p>
          <p @click="scrolltohere(1)" class="mr-[20px]" id="navmain">my goal</p>
          <p @click="scrolltohere(2)" class="mr-[20px]" id="navmain">
            tech stack
          </p>
          <p @click="scrolltohere(3)" class="mr-[20px]" id="navmain">
            my projects
          </p>
