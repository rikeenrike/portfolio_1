<template>
    <section id="section4" class="select-none h-fit overflow-hidden flex flex-col items-center px-[12px] xl:px-[112px]" >
        <div id="titlewrapper" class="flex flex-col leading-none my-10">   
            <h3 id="projecttitle" class="font-black text-light-brown text-clampsub text-left ml-0 lg:ml-[1%] ">school</h3>
            <h1 id="projecttitle" class="font-black text-dark-brown text-clamptitle items-center -mt-[5%] ">project hub.</h1>  
        </div>
      <div class="h-auto grid md:grid-cols-[1fr,1fr]">
        <div id="leftwingwrapper" class="mr-0 md:my-10 md:mr-10 h-fit">
            <div class="flex flex-row items-center pb-[10px] lg:gap-5">
                ...
                <a id="leftwing" class="font-black text-light-brown text-clamp4 cursor-none underline decoration-4" target="_blank" href="https://uiccafe.netlify.app/menu">UIC Cafe</a>
            </div>
